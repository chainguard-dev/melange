...
require (
	chainguard.dev/apko v0.8.1-0.20230530193724-faa1b37893ab
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20230530183318-2c9925797b40 // indirect
	...
	golang.org/x/build v0.0.0-20230530162711-6d3ea5d7e1e6 // indirect
