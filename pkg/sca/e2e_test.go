...
func TestAnalyze(t *testing.T) {
	for _, c := range []struct {
		...
		want: config.Dependencies{
			...
			Vendored: []string{
				"so:libXau-154567c4.so.6.0.0=0.13.2-r0",
				"so:libbrotlicommon-3ecfe81c.so.1=0.13.2-r0",
				"so:libbrotlidec-ba690955.so.1=0.13.2-r0",
				"so:libfreetype-f154df84.so.6.20.1=0.13.2-r0",
				"so:libgfortran-040039e1.so.5.0.0=0.13.2-r0",
				"so:libharfbuzz-2093a78b.so.0.60830.0=0.13.2-r0",
				"so:libjpeg-e44fd0cd.so.62.4.0=0.13.2-r0",
				"so:liblcms2-e69eef39.so.2.0.16=0.13.2-r0",
				"so:liblzma-13fa198c.so.5.4.5=0.13.2-r0",
				"so:libopenblas64_p-r0-0cf96a72.3.23.dev.so=0.13.2-r0",
				"so:libopenjp2-eca49203.so.2.5.0=0.13.2-r0",
				"so:libpng16-78d422d5.so.16.40.0=0.13.2-r0",
				"so:libquadmath-96973f99.so.0.0.0=0.13.2-r0",
				"so:libsharpyuv-20f78091.so.0.0.1=0.13.2-r0",
				"so:libtiff-91af027d.so.6.0.2=0.13.2-r0",
				"so:libwebp-850e2bec.so.7.1.8=0.13.2-r0",
				"so:libwebpdemux-df9b36c7.so.2.0.14=0.13.2-r0",
				"so:libwebpmux-9fe05867.so.3.0.13=0.13.2-r0",
				"so:libxcb-f0538cc0.so.1.1.0=0.13.2-r0",
			},
		},
	}, {
		...
		want: config.Dependencies{
			...
			Provides: []string{
				...
				"so:libnss_myhostname.so.2=256.2-r1",
				"so:libnss_mymachines.so.2=256.2-r1",
				"so:libnss_resolve.so.2=256.2-r1",
				"so:libnss_systemd.so.2=256.2-r1",
				"so:libudev.so.1=256.2-r1",
			},
			Vendored: []string{
				"so:libsystemd-core-256.so=256.2-r1",
				"so:libsystemd-shared-256.so=256.2-r1",
			},
		},
	}} {
