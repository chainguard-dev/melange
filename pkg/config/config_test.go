	...
	testCases := []struct {
		...
		},
		{
			...
			expected: &sbom.Package{
				...
				DownloadLocation: "https://tarballs.chainguard.dev/96d75acab51420a1b54afcc15734f3c5e67aee89a2e73f226000bc308ff09789-v3.2.1.tar.gz",
			},
			expectError: false,
		},
		{
			...
			expected: &sbom.Package{
				...
				DownloadLocation: "https://tarballs.chainguard.dev/96d75acab51420a1b54afcc15734f3c5e67aee89a2e73f226000bc308ff09789-abcdef0123456789abcdef0123456789abcdef01.tar.gz",
			},
			expectError: false,
		},
		{
		...
		},
		{
			...
			expected: &sbom.Package{
				...
				DownloadLocation: "https://tarballs.chainguard.dev/a37e698130227f6921f1963616a45dc5337f7249cc00c53e6b80f5a44bf01fd7-abcdef0123456789abcdef0123456789abcdef01.tar.gz",
			},
			expectError: false,
		},
	}
