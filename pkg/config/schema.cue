...
#PackageOption: close({
	...
	// Optional: Don't generate versioned depends for the shared
	// libraries this package links against, or for the pkg-config
	// packages its .pc files require. They are generated by
	// default.
