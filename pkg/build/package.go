...
func (pkg *Package) Emit(ctx context.Context, pb *PipelineBuild) error {
	...
	return fakesp.Emit(ctx, pb)
}

func (spkg *Subpackage) Emit(ctx context.Context, pb *PipelineBuild) error {
	pc := PackageBuild{
		Build:        pb.Build,
...
type DependencyGenerator func(*PackageBuild, *Dependencies) error
...
func generateCmdProviders(pc *PackageBuild, generated *Dependencies) error {
...
func generateSharedObjectNameDeps(pc *PackageBuild, generated *Dependencies) error {
